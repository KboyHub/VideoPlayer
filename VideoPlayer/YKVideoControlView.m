...
static const CGFloat kVideoControlTimeLabelFontSize = 60.0;
static const CGFloat kVideoControlBarAutoFadeOutTimeinterval = 5.0;

@interface YKVideoControlView ()
...
@implementation YKVideoControlView
...
- (void)layoutSubviews
{
    ...
    self.currentTimeLabel.frame = CGRectMake(CGRectGetMinX(self.bottomBar.bounds)+10, CGRectGetMaxY(self.bottomBar.bounds)/2 - CGRectGetMaxY(self.leftTimeLabel.bounds)/2, CGRectGetMaxX(self.currentTimeLabel.bounds), CGRectGetMaxY(self.currentTimeLabel.bounds));
   // self.pauseButton.frame = self.playButton.frame;
    ...
    self.progressSlider.frame = CGRectMake(CGRectGetMaxX(self.playButton.bounds)+10, CGRectGetMaxY(self.bottomBar.bounds)/2 - CGRectGetMaxY(self.progressSlider.bounds)/2, CGRectGetMaxX(self.bounds) - CGRectGetMaxX(self.playButton.bounds) - CGRectGetMaxX(self.fullScreenButton.bounds)-CGRectGetMaxX(self.currentTimeLabel.bounds), CGRectGetMaxY(self.progressSlider.bounds));
    self.leftTimeLabel.frame = CGRectMake(CGRectGetMaxX(self.progressSlider.frame)-10, CGRectGetMaxY(self.bottomBar.bounds)/2 - CGRectGetMaxY(self.leftTimeLabel.bounds)/2, CGRectGetMaxX(self.leftTimeLabel.bounds), CGRectGetMaxY(self.leftTimeLabel.bounds));
    self.indicatorView.center = CGPointMake(CGRectGetMidX(self.bounds), CGRectGetMidY(self.bounds));
    
    self.playButton.center = self.indicatorView.center;
    self.pauseButton.center = self.indicatorView.center;
...
- (UILabel *)currentTimeLabel
{
    if (!_currentTimeLabel) {
        ...
        _currentTimeLabel.bounds = CGRectMake(0, 0, kVideoControlTimeLabelFontSize, 30);
    }
...
- (UILabel *)leftTimeLabel
{
    if (!_leftTimeLabel) {
        ...
        _leftTimeLabel.bounds = CGRectMake(0, 0, kVideoControlTimeLabelFontSize, 30);
    }
